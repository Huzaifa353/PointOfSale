...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        if($role->hasPermissionTo('users-index')){
            ...
            $lims_user_list = User::where('is_deleted', false)->where('role_id', '!=', 2)->get();
    ...
    public function create()
    {
        ...
        if($role->hasPermissionTo('users-add')){
            $lims_role_list = Roles::where('is_active', true)->where('id', '!=', 2)->get();
    ...
    {
        $lims_user_list = DB::table('users')->where('is_active', true)->where('role_id', '!=', 2)->get();
