                        ...
                        {!! Form::open(['route' => 'setting.posStore', 'method' => 'post']) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <!--<input type="text" name="stripe_public_key" class="form-control" value="@if($lims_pos_setting_data){{$lims_pos_setting_data->stripe_public_key}}@endif" />-->
                                                <input type="hidden" name="stripe_public_key" class="form-control" value="pk_test_ITN7KOYiIsHSCQ0UMRcgaYUB" />
                                ...
                                <!--    <div class="form-group">-->
                                        ...
                                        <input type="hidden" name="stripe_secret_key" class="form-control" value="sk_test_TtQQaawhEYRwa3mU9CzttrEy" />
                            <!--        </div>-->
                            <!--    </div>-->
                            <!--</div> -->
                            ...
                            <!--    <div class="col-md-12">-->
                                ...
                                <!--    <div class="form-group">-->
                                        ...
                                        <input type="hidden" name="paypal_username" class="form-control" value="admin" />
                                <!--    </div>-->
                                <!--</div>-->
                                <!--<div class="col-md-6">-->
                                <!--    <div class="form-group">-->
                                        <!--<label>Paypal Pro API Signature</label>-->
                                        <input type="hidden" name="paypal_signature" class="form-control" value="admin" />
                                <!--    </div>-->
                                <!--</div>-->
                                <!--<div class="col-md-6">-->
                                <!--    <div class="form-group">-->
                                        <!--<label>Paypal Pro API Password</label>-->
                                        <input type="hidden" name="paypal_password" class="form-control" value="admin" />
                                <!--    </div>-->
                                <!--</div>-->
                            </div>
                            <!--<hr>-->
                            ...
                            <!--        <div class="form-group d-inline">-->
                                        <input class="mt-2" type="hidden" name="options[]" value="cash" checked>
                                    <!--</div>-->
