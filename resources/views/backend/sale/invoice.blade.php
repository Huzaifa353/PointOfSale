                ...
                <div class="widget-box">
                    <div class="widget-header widget-header-large">
                        ...
                        <div class="widget-toolbar no-border invoice-info">
                            <span class="invoice-info-label">{{trans('file.reference')}}:</span>
                            <span class="red">{{$lims_sale_data->reference_no}}</span>
                            <br>
                            <span class="invoice-info-label">{{trans('file.Date')}}:</span>
                            <span class="blue">{{date($general_setting->date_format,
                                strtotime($lims_sale_data->created_at->toDateString()))}}</span>
...
?>
                    ...
                    <div class="widget-body">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div>
                                        <ul class="list-unstyled spaced">
                                            <li>
                                                <i class="ace-icon fa fa-caret-right blue"></i>{{trans('file.Address')}}: {{$lims_warehouse_data->address}}
                                            </li>
                                            <li>
                                                <i class="ace-icon fa fa-caret-right blue"></i>
                                                {{trans('file.Phone Number')}}:
                                                <b class="red">{{$lims_warehouse_data->phone}}</b>
                                             
                                            </li>
                                            @if($general_setting->vat_registration_number)
                                                <li>
                                                    <i class="ace-icon fa fa-caret-right blue"></i>{{trans('file.VAT Number')}}:
                                                    <b class="red">{{$general_setting->vat_registration_number}}</b>
                                                </li>
                                         @endif
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div>
                                        <ul class="list-unstyled  spaced">
                                            ...
                                            <li>
                                                <i class="ace-icon fa fa-caret-right green"></i> {{trans('file.Date')}}:

                                                <b class="red">{{date($general_setting->date_format, strtotime($lims_sale_data->created_at->toDateString()))}}</b>
                                            </li>
                        

                                            <li>
                                                <i class="ace-icon fa fa-caret-right green"></i>{{trans('file.customer')}}:

                                                <b class="red">{{$lims_customer_data->name}}</b>
                                            </li>


                                            <li>
                                                <i class="ace-icon fa fa-caret-right green"></i>{{trans('file.reference')}}:

                                                <b class="red">{{$lims_sale_data->reference_no}}</b>
                                            </li>
                                            ...
                                            <li>
                                                <i class="ace-icon fa fa-caret-right green"></i>{{trans('file.Table')}}:

                                                <b class="red">{{$lims_sale_data->table->name}}</b>
                                            </li>


                                            <li>
                                                <i class="ace-icon fa fa-caret-right green"></i>{{trans('file.Queue')}}:

                                                <b class="red">{{$lims_sale_data->queue}}</b>
                                            </li>
                        ...
                        @endif
                                            ...
                                            <td>
                                                {{number_format((float)($product_sale_data->total), $general_setting->decimal, '.', ',')}}
                                            </td>
                            ...
                            <div class="row">
                                <div class="col-sm-5 pull-right">
                                    <h4 class="pull-right">
                                        {{trans('file.Total')}} :
                                        <span class="red">{number_format((float)($lims_sale_data->total_price), $general_setting->decimal, '.', ',')}}</span>
                                    </h4>
                                </div>
