...
@php
    ...
    $currentBillerId = Auth::user()->biller_id;
@endphp
<section class="forms">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="created_at" class="form-control" placeholder="Choose date" value="{{ $todayDate }}" readonly/>
                                        </div>
                                    </div>
                                    <!--<div class="col-md-4">-->
                                    <!--    <div class="form-group">-->
